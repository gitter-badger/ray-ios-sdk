...
/// The YellaSDK delegate
@property (nonatomic, weak) id <RSDKDelegate> __nullable delegate;
...
/// The time to wait (seconds) before a beacon is registered
///
/// Default value is 10 seconds
@property (nonatomic) NSTimeInterval timeToWait;
...
/// Returns the YellaSDK singleton instance
///
/// \returns The YellaSDK instance created in <code>RSDK</code>
...
///
/// <code>yellaManager(_:didRangeYellaBeacon:inRegion:)</code> will only execute iff verification passed and RSSI is less than 0
///
/// \param manager The location manager object reporting the event.
///
...
/// The delegate of a <code>RSDK</code> object must adopt the <code>YellaSDKDelegate</code> protocol.
SWIFT_PROTOCOL("_TtP6RaySDK12RSDKDelegate_")
@protocol RSDKDelegate <NSObject>

/// Tells the delegate that a beacon was ranged. The beacon will first be verified first before being returned
///
/// \param beacon The returned <code>CLBeacon</code> object that was ranged and verified
///
/// \param identifier The region identifier of the region ranged
- (void)rsdkDidRangeYellaBeacon:(RSDKBeacon * __null_unspecified)beacon inRegionWithIdentifier:(NSString * __nonnull)identifier;
@optional
